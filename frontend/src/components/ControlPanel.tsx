        ...
        <div className="w-full bg-white/90 backdrop-blur-xl border border-slate-200 rounded-3xl p-6 shadow-xl shadow-slate-100 text-slate-800">            
          ...
          <div className="mb-6">                                                                                                                           
            <div className="flex justify-between items-center mb-2">                                                                                       
              <label className="text-sm font-semibold text-slate-500">借入金額</label>                                                                     
          ...
          <div className="mb-6">                                                                                                                           
            <div className="flex justify-between items-center mb-2">                                                                                       
              <label className="text-sm font-semibold text-slate-500">返済期間</label>                                                                     
              <div className="flex items-baseline gap-0.5">                                                                                                
          ...
          {/* 3. 返済方法 (元利均等 / 元金均等) */}                                                                                                        
          <div className="mb-6">                                                                                                                           
            <label className="text-sm font-semibold text-slate-500 block mb-2">返済方法</label>                                                            
          ...
          {/* 4. 金利タイプ */}                                                                                                                            
          <div className="mb-6">                                                                                                                           
            <label className="text-sm font-semibold text-slate-500 block mb-2">金利タイプ</label>                                                          
          ...
          <div className="p-4 bg-blue-50/40 border border-blue-100/60 rounded-2xl mb-6">                                                                   
            ...
            <div className="mb-4">                                                                                                                         
              <div className="flex justify-between items-center mb-1">                                                                                     
                <span className="text-xs text-slate-500 font-medium">当初固定期間</span>                                                                   
            ...
            <div>                                                                                                                                          
              <div className="flex justify-between items-center mb-1">                                                                                     
                <span className="text-xs text-slate-500 font-medium">4年目以降の想定金利</span>                                                            
          ...
          <div className="border-t border-slate-100 pt-4">                                                                                                 
            <div className="flex justify-between items-center">                                                                                            
              <span className="text-sm font-semibold text-slate-500">繰り上げ返済を追加</span>                                                             
            ...
            <div className="mt-4 p-3 bg-slate-50/50 border border-slate-200/50 rounded-xl space-y-3">                                                      
              <div className="flex justify-between items-center text-xs">                                                                                  
                ...
                <div className="flex gap-2">                                                                                                               
                  <span className="text-blue-600 bg-white border border-slate-200/60 px-2 py-0.5 rounded-md font-semibold">期間短縮</span>                 
                  <span className="text-slate-400 px-2 py-0.5 rounded-md font-semibold">返済額軽減</span>                                                  
                </div>                                                                                                                                     
              </div>                                                                                                                                       
              <div className="flex justify-between items-center text-xs">                                                                                  
